...
public class FilterBarItemAuthorView extends FilterBarItemView {
    ...
    public FilterBarItemAuthorView(@NonNull Context context) {
        super(context);
    }

    public FilterBarItemAuthorView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public String getName(int quantity) {
        return context.getResources().getQuantityString(R.plurals.authors, quantity, quantity);
    }
